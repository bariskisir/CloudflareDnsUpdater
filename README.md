...
CloudflareDnsUpdater is a background service running on .NET 10. This service frequently checks domains' A records and update them with the current IP address.
